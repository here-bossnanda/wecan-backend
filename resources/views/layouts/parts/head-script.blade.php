...
<!-- dropify  -->
<link  href="{{asset('assets/libs/dropify-master/dist/css/dropify.min.css')}}" rel="stylesheet" type="text/css">
<!--  select2  -->
<link href="{{asset('assets/libs/select2/dist/css/select2.min.css')}}" rel="stylesheet" />
<!--  DualList Box  -->
<link href="{{asset('assets/libs/listviewbox/jquery.lwMultiSelect.css')}}" rel="stylesheet" />
<!-- Bootstrap Css -->
